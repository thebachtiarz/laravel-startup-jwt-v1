...
const createUserPanel = (data) => {
    let panel = `<div class="user-panel mt-3 pb-3 mb-3 d-flex"><div class="image"><img src="http://www.bachtiars.com/AdminLTE-3.0.1/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image"></div><div class="info"><a href="#" class="d-block">${data.credentials}</a></div></div><div class="user-panel mt-2 pb-2 mb-2" id="sidebarLink"></div>`;
